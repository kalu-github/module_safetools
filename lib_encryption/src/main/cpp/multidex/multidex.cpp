...
extern "C" JNIEXPORT
jlong JNICALL obtainCheckSum(JNIEnv *env, jclass, jstring filePath) {
//Java_lib_kalu_core_cmake_multidex_BoostNative_obtainCheckSum(JNIEnv *env, jclass, jstring filePath) {
...
extern "C"
JNIEXPORT jobject JNICALL loadDirectDex(JNIEnv *env, jclass,
                                                             jstring jFilePath,
                                                             jbyteArray jFileContents) {
//Java_lib_kalu_core_cmake_multidex_BoostNative_loadDirectDex(JNIEnv *env, jclass,
//                                                             jstring jFilePath,
//                                                             jbyteArray jFileContents) {
...
extern "C"
JNIEXPORT void JNICALL recoverAction(JNIEnv *, jclass) {
//Java_lib_kalu_core_multidex_BoostNative_recoverAction(JNIEnv *, jclass) {
    if (sIsSetHandler) {
        sigaction(SIGSEGV, &OldSignalAction, nullptr);
    }
}
...
extern "C"
JNIEXPORT jboolean JNICALL makeOptDexFile(JNIEnv *env, jclass,
                                                              jstring jFilePath,
                                                              jstring jOptFilePath) {
//Java_lib_kalu_core_cmake_multidex_BoostNative_makeOptDexFile(JNIEnv *env, jclass,
//                                                              jstring jFilePath,
//                                                              jstring jOptFilePath) {
...
extern "C"
JNIEXPORT jboolean JNICALL initialize(JNIEnv *env, jclass, jint sdkVersion, jclass runtimeExceptionClass) {
//Java_lib_kalu_core_cmake_multidex_BoostNative_initialize(JNIEnv *env, jclass, jint sdkVersion, jclass runtimeExceptionClass) {
