...
public class Box {
    ...
    static {
        System.loadLibrary("openssl_kit");
    }
    ...
    private static native byte[] _aesEcbEncrypt(byte[] key, byte[] data, boolean useBase64);

    private static native byte[] _aesEcbDecrypt(byte[] key, byte[] data, boolean useBase64);

    private static native byte[] _aesCbcEncrypt(byte[] key, byte[] iv, byte[] data, boolean useBase64);

    private static native byte[] _aesCbcDecrypt(byte[] key, byte[] iv, byte[] data, boolean useBase64);
