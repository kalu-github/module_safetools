...
# 指定class模糊字典
-classobfuscationdictionary proguard-dict_cn2.txt
...
# 1. 表示不混淆任何包含native方法的类的类名以及native方法名，这个和我们刚才验证的结果是一致
-keepclasseswithmembernames class * {
    native <methods>;
}


# 2. 不混淆使用了 @Keep 注解相关的类
